...
<h1 className="text-xl sm:text-2xl md:text-4xl font-quicksand mb-4 text-[#555555]">
  🌈Bienvenid@ a este rincón donde la magia cobra forma de papel
</h1>
<p className="text-base sm:text-lg md:text-2xl mx-auto font-quicksand text-[#A56ABF]">
